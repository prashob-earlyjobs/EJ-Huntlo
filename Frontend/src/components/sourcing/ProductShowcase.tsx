            ...
            <div className="flex-1 bg-slate-900 p-6 overflow-hidden flex flex-col">
              ...
              <div className="relative mb-6">
                ...
                <input 
                  ...
                  className="w-full bg-slate-800 border border-slate-700 text-white placeholder-slate-400 rounded-xl pl-12 pr-4 py-4 focus:outline-none focus:border-blue-500 transition-colors"
                />
                <button className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-colors">
                  Search
                </button>
              </div>
              ...
              <div className="space-y-3 flex-1 overflow-y-auto pr-2 custom-scrollbar">
                {[
                  ...
                  <div key={i} className="p-4 rounded-xl border border-slate-700 bg-slate-800/50 hover:bg-slate-800 transition-colors cursor-pointer flex gap-4">

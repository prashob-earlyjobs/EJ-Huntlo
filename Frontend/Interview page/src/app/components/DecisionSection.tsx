      ...
      <div className="flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="w-full lg:w-1/2 space-y-6">
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 tracking-tight">
            A Complete View Of Every Candidate
          </h2>
          <div className="pt-2">
            <h3 className="text-xl font-semibold text-slate-800 mb-3">
              Interview intelligence in one place.
            </h3>
            <p className="text-lg text-slate-500 leading-relaxed max-w-md">
              Combine sourcing signals, assessments, interview feedback, and hiring recommendations into one candidate profile.
            </p>
          </div>
        </div>
                ...
                <div key={i} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                  ...
                  <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-slate-100 bg-white shadow-sm transition-all duration-300 hover:shadow-md hover:border-blue-100 group-odd:mr-auto group-even:ml-auto">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[10px] font-bold text-slate-400 bg-slate-100 px-2 py-0.5 rounded-full">Completed</span>
                    </div>
                  </div>
                </div>
              ))}
